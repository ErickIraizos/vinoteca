...
<div class="dashboard-header">
    ...
    <span class="fw-bold fs-4 d-flex align-items-center">
        ...
        <span class="fw-bold fs-4"><i class="fas fa-tags me-2"></i><?= isset($categoria) ? 'Editar Categoría' : 'Nueva Categoría' ?></span>
    </div>
    <div class="user-info">
...
<div class="container-fluid">
    ...
    <div class="main-card card">
        <div class="card-header">
            <span class="card-title"><?= isset($categoria) ? 'Editar Categoría' : 'Nueva Categoría' ?></span>
        </div>
        <div class="card-body">
            <form action="<?= BASE_URL ?>admin/categoriaForm<?= isset($categoria) ? '/' . $categoria['categoria_id'] : '' ?>" method="POST">
                <div class="mb-3">
                    <label for="nombre" class="form-label">Nombre *</label>
                    <input type="text" class="form-control" id="nombre" name="nombre" value="<?= isset($categoria) ? htmlspecialchars($categoria['nombre']) : '' ?>" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="imagen_url" name="imagen_url" value="<?= isset($categoria) ? htmlspecialchars($categoria['imagen_url']) : '' ?>" placeholder="https://...">
                    <small class="form-text text-muted">Pega la URL de la imagen (JPG, PNG, GIF).</small>
                </div>
                <div class="mb-3 form-check">
                    <input type="checkbox" class="form-check-input" id="activa" name="activa" value="1" <?= (!isset($categoria) || $categoria['activa']) ? 'checked' : '' ?>>
                    <label class="form-check-label" for="activa">Categoría Activa</label>
                </div>
                <div class="d-flex justify-content-between">
                    <a href="<?= BASE_URL ?>admin/categorias" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Volver</a>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ¿Estás seguro de que deseas guardar los cambios de esta categoría?
      </div>
