...
<div class="dashboard-header">
    <div class="logo">
        ...
        <span class="fw-bold fs-4"><i class="fas fa-truck me-2"></i>Editar Proveedor</span>
    </div>
    <div class="user-info">
...
<div class="container-fluid">
    ...
    <div class="main-card card mx-auto" style="max-width: 700px;">
        <div class="card-header">
            <span class="card-title"><i class="fas fa-edit me-2"></i>Editar Proveedor</span>
        </div>
        <div class="card-body">
            <form id="formEditarProveedor" action="<?= BASE_URL ?>admin/proveedores/actualizar/<?= $proveedor['proveedor_id'] ?>" method="POST" class="row g-3">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="pais" class="form-control" value="<?= htmlspecialchars($proveedor['pais']) ?>">
                </div>
                <div class="col-12 d-flex justify-content-end gap-2">
                    <button type="button" id="btnAbrirModalActualizar" class="btn btn-success"><i class="fas fa-save me-1"></i>Actualizar</button>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header bg-success text-white">
        <h5 class="modal-title" id="modalConfirmarActualizarLabel"><i class="fas fa-save me-2"></i>Confirmar actualización</h5>
        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Cerrar"></button>
      </div>
      <div class="modal-body">
        <p>¿Estás seguro de que deseas actualizar los datos de este proveedor?</p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
        <button type="button" id="btnConfirmarActualizar" class="btn btn-success">Actualizar</button>
      </div>
    </div>
  </div>
</div>
...
<script>
    document.getElementById('btnAbrirModalActualizar').addEventListener('click', function(e) {
        e.preventDefault();
        const modal = new bootstrap.Modal(document.getElementById('modalConfirmarActualizar'));
        modal.show();
    });
