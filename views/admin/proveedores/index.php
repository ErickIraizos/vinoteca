...
<div class="dashboard-header">
    <div class="logo">
        ...
        <span class="fw-bold fs-4"><i class="fas fa-truck me-2"></i>Gestión de Proveedores</span>
    </div>
    <div class="user-info">
...
<div class="container-fluid">
    ...
    <div class="main-card card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="<?= BASE_URL ?>admin/proveedores/crear" class="btn btn-success">
                ...
                <table class="table table-hover datatable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= htmlspecialchars($proveedor['pais']) ?></td>
                            <td>
                                <div class="btn-group">
                                    <a href="<?= BASE_URL ?>admin/proveedores/editar/<?= $proveedor['proveedor_id'] ?>" class="btn btn-primary btn-sm" title="Editar"><i class="fas fa-edit"></i></a>
                                    <a href="#" data-eliminar-url="<?= BASE_URL ?>admin/proveedores/eliminar/<?= $proveedor['proveedor_id'] ?>" class="btn btn-danger btn-sm btn-eliminar-proveedor" title="Eliminar"><i class="fas fa-trash"></i></a>
                                </div>
                            </td>
                        </tr>
                        <?php endforeach; ?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header bg-danger text-white">
        <h5 class="modal-title" id="modalEliminarProveedorLabel"><i class="fas fa-trash-alt me-2"></i>Confirmar eliminación</h5>
...
<script>
    $(document).ready(function() {
        ...
        // Modal de confirmación de eliminación
        let urlEliminar = '';
        $('.btn-eliminar-proveedor').on('click', function(e) {
            e.preventDefault();
            urlEliminar = $(this).data('eliminar-url');
            const modal = new bootstrap.Modal(document.getElementById('modalEliminarProveedor'));
            modal.show();
        });
        $('#btnConfirmarEliminar').on('click', function(e) {
            e.preventDefault();
            if (urlEliminar) {
