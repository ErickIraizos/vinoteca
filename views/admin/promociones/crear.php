...
<div class="dashboard-header">
    <div class="logo">
        ...
        <span class="fw-bold fs-4"><i class="fas fa-percent me-2"></i>Nueva Promoción</span>
    </div>
    <div class="user-info">
...
<div class="container-fluid">
    ...
    <div class="main-card card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <span class="card-title"><i class="fas fa-percent text-danger me-2"></i>Nueva Promoción</span>
        </div>
        <div class="card-body">
            <form method="post">
                <div class="row g-3 mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" name="descuento_porcentaje" id="descuento_porcentaje" class="form-control" min="0" max="100" step="0.01" required>
                    </div>
                </div>
                <div class="row g-3 mb-3">
                    <div class="col-md-6">
                ...
                <button type="submit" class="btn btn-success btn-lg"><i class="fas fa-save"></i> Guardar promoción</button>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ¿Estás seguro de que deseas guardar esta promoción?
      </div>
